    ...
    async def _scan_symbol(
        ...
        if self.bds.polygon_client is not None:
            try:
                ...
                logger.warning("event=vol_exp_bars_fail symbol=%s source=polygon error=%s", symbol, exc)
        ...
        if not bars:
            ...
            try:
                ...
                logger.warning("event=vol_exp_bars_fail symbol=%s source=tradier error=%s", symbol, exc)
